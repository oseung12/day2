...
pointArr.sort((a , b ) => {
    const distanceA = Math.sqrt( Math.pow( pointArr.apos - target.apos , 2) +
        Math.pow(pointArr.bpos - target.bpos - target.bpos,2))
...
//       Math.pow(pointArrElement.ypos - target.ypos - target.ypos,2))
//
